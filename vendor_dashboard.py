...
div[data-testid="stMetric"]:nth-child(1) { background-color: #e3f2fd; border-color: #211832; } /* Blue */
div[data-testid="stMetric"]:nth-child(2) { background-color: #f1f8e9; border-color: #211832; } /* Green */
div[data-testid="stMetric"]:nth-child(3) { background-color: #fff3e0; border-color: #211832; } /* Orange */
div[data-testid="stMetric"]:nth-child(4) { background-color: #fce4ec; border-color: #211832; } /* Pink */
div[data-testid="stMetric"]:nth-child(5) { background-color: #ede7f6; border-color: #211832; } /* Purple */
